...
**my goal here is to find out which DAs belong to which Vancouver neighbourhoods, group**
**these DAs together, and aggregate census profile characteristics to the Vancouver**
**neighbourhood level.**
...
ggsave("figs/mvn_f1.png", width = 6, height = 6)
```
